  ...
  return (
      <StyledMap xmlns="http://www.w3.org/2000/svg" viewBox="40 40 215 380" preserveAspectRatio="xMinYMin meet">
        <g id="outlines">
          ...
          {/* <path id="CO" className="state" d="M380.2 235.5l-36-3.5-79.1-8.6-2.2 22.1-7 50.4-1.9 13.7 34 3.9 37.5 4.4 34.7 3 14.3.6z"/> */}
          {/* <path id="NM" className="state" d="M270.2 429.4l-16.7-2.6-1.2 9.6-15.8-2 6-39.7 7-53.2 4.4-30.9 34 3.9 37.4 4.4 32 2.8-.3 10.8-1.4-.1-7.4 97.7-28.4-1.8-38.1-3.7.7 6.3z"/> */}
        </g>
      </StyledMap>
  )
}
